...
export default function Institution() {
  ...
  return (
    <>
      ...
      <section
        id="= start-section"
        className="relative md:py-48 py-36 items-center mt-[74px] md:mx-4 md:rounded-3xl overflow-hidden"
      >
          ...
          >
            <div className="">
              <h4 className="font-bold lg:leading-normal leading-normal  text-4xl lg:text-7xl mb-5">
                ...
                >
                  {' '}
                  revolutionary blend of AI and Education
                </span>{' '}
              </h4>
