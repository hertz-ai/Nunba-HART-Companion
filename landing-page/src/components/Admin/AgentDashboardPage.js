        ...
        <CardContent sx={{p: 2.5}}>
          ...
          >
            <Box sx={{display: 'flex', alignItems: 'center', gap: 1.5}}>
              <SmartToyIcon
                sx={{fontSize: 20, color: 'rgba(255,255,255,0.4)'}}
              />
              <Box>
                <Typography
                  variant="body2"
          ...
          {agent.last_active && (
            <Typography
              variant="caption"
              sx={{color: 'rgba(255,255,255,0.3)', display: 'block', mt: 1}}
            >
                ...
                <Grid container spacing={2}>
                  <Grid item xs={3}>
                    <Box sx={{textAlign: 'center'}}>
                      <Typography
                        variant="h5"
                        sx={{fontWeight: 700, color: '#9B94FF'}}
                      >
                        {summary.total}
                      </Typography>
                      <Typography
                  ...
                  {summary.by_status &&
                    Object.entries(summary.by_status).map(([s, c]) => (
                      <Grid item xs key={s}>
                        <Box sx={{textAlign: 'center'}}>
                          <Typography
                            variant="h5"
